...
const ProductForm = ( props ) => {
    ...
    useEffect( () => {
        if ( singleProduct ) {
            setProductValue( {
                ...
                product_mrp: singleProduct ? singleProduct[ 0 ].product_mrp : '',
    ...
    const handleValidation = () => {
        ...
        } else if ( !productValue[ 'product_mrp' ] ) {
            errorss[ 'product_mrp' ] = getFormattedMessage( 'product.input.product-mrp.validate.label' );
    ...
    const prepareFormData = ( data ) => {
        ...
        formData.append( 'product_mrp', data.product_mrp );
                        ...
                        <div className='col-xl-8'>
                            <div className='card'>
                                <div className='row'>
                                    ...
                                    <div className='col-md-6 mb-3'>
                                        <label
                                            className='form-label'>{getFormattedMessage( 'product.input.product-mrp.label' )}: </label>
                                        <span className='required' />
                                        <InputGroup>
                                            <input type='text' name='product_mrp'
                                                min={0} className='form-control'
                                                placeholder={placeholderText( 'product.input.product-mrp.placeholder.label' )}
                                                onKeyPress={( event ) => decimalValidate( event )}
                                                onChange={( e ) => onChangeInput( e )}
                                                value={productValue.product_mrp} />
